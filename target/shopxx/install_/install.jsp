				...
				$.ajax({
					...
					success: function(data) {
						if (data.status == "success") {
							...
							$installMessage.html('<div id="installSuccess" class="installSuccess"><strong>恭喜您，安装成功，请重新启动WEB服务器！<\/strong><span>基于安全考虑，请在安装成功后删除install目录<\/span><\/div>');
